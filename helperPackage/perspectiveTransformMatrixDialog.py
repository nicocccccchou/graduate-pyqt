...
class PerspectiveTransformMatrixDialog(QDialog):
    def __init__(self, parent=None):
        super(PerspectiveTransformMatrixDialog, self).__init__(parent)

        self.setWindowTitle('PerspectiveTransformMatrixDialog')
        ...
        self.srcLabel.setText("输入图像的四个顶点的坐标")
        self.srcLine = QLineEdit(self)
        self.srcLine.setPlaceholderText("输入图像的四个点坐标，形如[[x1,y1],[x2,y2],[x3,y3],[x4,y4]]")

        self.dstLabel = QLabel(self)
        self.dstLabel.setText("输出图像的四个顶点的坐标")
        self.dstLine = QLineEdit(self)
        self.dstLine.setPlaceholderText("输出图像的四个点坐标，形如[[x1,y1],[x2,y2],[x3,y3],[x4,y4]]")
    ...
    def downloadMatrix(self):
        ...
        self.downloadLine.setText(downloadPath + "/perspectiveTransformMatrix.txt")
